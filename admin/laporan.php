 ...
 <!-- Sidebar Toggler (Sidebar) -->
    ...
    <table class="table table-bordered table-hover">
        ...
        if (isset($_POST['tgl_awal'])&& isset($_POST['tgl_akhir'])) {
            ...
            $sql="select * from izin where created_at between '".$tgl_awal."' and '".$tgl_akhir."' order by id_surat asc";

        }else {
            $sql="select * from izin order by id_surat asc";
        }
        if(isset($_POST['tgl_awal'])&& isset($_POST['tgl_akhir'])) {
