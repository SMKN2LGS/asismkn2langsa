...
<!-- Tambah Modal-->
    <div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <form action="tambah_siswa.php" id="form_edit" method="GET">
                <div class="form-group">
                    <label for="pwd">NISN :</label>
                    <input type="number" class="form-control" name="nisn"  maxlength="20">
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="nohp" maxlength="20">
                </div>
                <div class="form-group">
                    <label for="jk">Jurusan :</label>
                    <select name="jurusan" class="form-control" aria-label="Default select example">
                        <option value="RPL">RPL (Rekayasa Perangkat Lunak)</option>
                        <option value="TKJ">TKJ (Teknik Komputer Jaringan)</option>
                        <option value="TITL">TITL (Teknik Instalasi Listrik)</option>
                        <option value="TP">TP (Teknik Pendingin)</option>
                        <option value="TP">TP (Teknik Kendaraan Ringan)</option>
                        <option value="TP">TP (Teknik dan Bisnis Sepeda Motor)</option>
                        <option value="TP">TP (Pengelasan)</option>
                    </select>
                </div>
                <div class="form-group">
...
$id = $_GET['id'];
$tool = mysqli_query($conn,"SELECT * FROM siswa where id ='$id'");
$tampil = mysqli_fetch_array($tool)
    ?>
                                        <tr>
                                                <form action="edit_siswa.php" id="editgr" method="GET">
                                                    <td><a href="#" onclick="document.getElementById('editgr').submit()" class="btn btn-primary">Ubah</a></td>
                                                    <td><input type="number" value="<?php echo $tampil['nisn']?>" name="nisn"></td>
...
<?php } ?>
                                                    ...
                                                    <td><input type="text" value="<?php echo $tampil['nohp']?>" name="nohp"></td>
                                                    <td>

                                                      <select name="jurusan" class="form-select" aria-label="Default select example">
                                                        <option value="<?php echo $tampil['jurusan']?>"><?php echo $tampil['jurusan']?></option>
                                                        <option value="RPL">RPL (Rekayasa Perangkat Lunak)</option>
                                                        <option value="TKJ">TKJ (Teknik Komputer Jaringan)</option>
                                                    </select>


                                                        <input type="hidden" value="<?php echo $tampil['id']?>" name="id">
...
{ ?>
                                        <tr>
                                            <td><?php if($_GET['task'] == 'edit'){ ?>
                                                ...
                                                <a href="murid.php?task=edit&modal=edit&id=<?php echo $row['id']?>"   class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i
                 ...
                 <a href="del_siswa.php?id=<?php echo $row['id']?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
                                class="fas fa-trash text-white-50"></i> Hapus</a>
