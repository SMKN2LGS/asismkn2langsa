...
$con_petugas = mysqli_query($conn,"SELECT * FROM guru");
$con_murid = mysqli_query($conn,"SELECT * FROM siswa");
$con_surat = mysqli_query($conn,"SELECT * FROM izin");
$petugas =mysqli_num_rows($con_petugas);
$murid =mysqli_num_rows($con_murid);
$surat =mysqli_num_rows($con_surat);
?>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Siswa</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $murid; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-users fa-2x text-gray-300"></i>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Surat</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $surat; ?></div>
                                        </div>
                                        <div class="col-auto">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kholis x Rachel 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
