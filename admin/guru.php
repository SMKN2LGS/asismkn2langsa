    ...
    <div class="modal fade" id="TambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="tambah_guru.php" id="form_edit" method="GET">
            <div class="form-group">
             <label for="pwd">Kode Guru :</label>
            <input type="text" class="form-control" name="kode_guru"  maxlength="10">
            </div>
            <div class="form-group">
             <label for="pwd">Nama Guru :</label>
            <input type="text" class="form-control" name="nama_guru"  maxlength="50">
            </div>
            <div class="form-group">
             <label for="pwd">Bidang :</label>
            <input type="text" class="form-control" name="jurusan" maxlength="50">
            </div>
            <div class="form-group">
             <label for="jk">Jenis Kelamin :</label>
            <select name="jenis_kelamin" id="jk" class="form-control" aria-label="Default select example">
...
$id = $_GET['id'];
$tool = mysqli_query($conn,"SELECT * FROM guru where id_guru ='$id'");
$tampil = mysqli_fetch_array($tool)
    ?>
                                                <tr>
                                                <form action="../controller/edit_guru.php" id="editgr" method="GET">
                                                    <td><a href="#" onclick="document.getElementById('editgr').submit()" class="btn btn-primary">Ubah</a></td>
                                                    <td><input type="text" value="<?php echo $tampil['kode_guru']?>" name="kode_guru"></td>
                                                    <td><input type="text" value="<?php echo $tampil['nama_guru']?>" name="nama_guru"></td>
                                                    <td><input type="text" value="<?php echo $tampil['jurusan']?>" name="jurusan"></td>
                                                    <td><input type="text" value="<?php echo $tampil['jenis_kelamin']?>" name="jenis_kelamin"></td>
                                                        <input type="hidden" value="<?php echo $tampil['id_guru']?>" name="id_guru">
...
{ ?>
                                        <tr>
                                            <td><?php if($_GET['task'] == 'edit'){ ?>
                                                ...
                                                <a href="guru.php?task=edit&modal=edit&id=<?php echo $row['id_guru']?>"   class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i
                 ...
                 <a href="del_guru.php?id=<?php echo $row['id_guru']?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
                                class="fas fa-trash text-white-50"></i> Hapus</a>
